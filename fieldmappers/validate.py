...
def validate(val_data, model, criterion, buffer, valLoss, gpu):
    """
        Validate model
        ...
        Params:
            ...
            buffer: 
                Buffer added to the targeted grid when creating dataset. 
    ...
    for img, label in val_data:
        ...
        loss = eval(criterion)(out[:, :, buffer:-buffer, buffer:-buffer],
