...
def evaluate2(model, dataloader, num_classes, class_mapping, buffer=None, 
              out_name=None):
    """
    ...
    Args:
        ...
        buffer (int, optional): The number of pixels to ignore along the 
            ...
            Defaults to None.
        out_name (str, optional): The path where the evaluation metrics are to 
            be saved. If None, metrics are not saved. Defaults to None.
    ...
    Notes:
        ...
        If out_name is provided, it also saves the overall and per-class metrics 
        into CSV files.
    """
